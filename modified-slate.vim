" Name:         modified-slate
" Description:  Remake of modified-slate
...
hi clear
let g:colors_name = 'modified-slate'
...
hi Todo guifg=#00ff00 guibg=#c45508 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Todo ctermfg=7 ctermbg=131 cterm=NONE
