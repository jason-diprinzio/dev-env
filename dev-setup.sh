...
$(cd "${install_dir}"/vim && bash -c ./configure --prefix=/usr/local --with-compiledby=jasondiprinzio --with-features=huge --enable-multibyte --enable-channel --enable-terminal --enable-pythoninterp --enable-python3interp --enable-perlinterp --enable-xim)
