...
$(cd "${install_dir}"/vim && bash -c ./configure --prefix=/usr/local --with-compiledby=jasondiprinzio --with-features=huge --enable-multibyte --enable-channel --enable-terminal --enable-python3interp=dynamic --enable-perlinterp --enable-xim)
